...
package com.sakura.settings.fragments.ui;
...
public class SmartPixels extends SettingsPreferenceFragment {
    ...
    public static void reset(Context mContext) {
        ...
        Settings.Secure.putIntForUser(resolver,
                Settings.System.SMART_PIXEL_FILTER_ENABLED, 0, UserHandle.USER_CURRENT);
        Settings.Secure.putIntForUser(resolver,
                Settings.System.SMART_PIXEL_FILTER_PERCENT, 25, UserHandle.USER_CURRENT);
    }
