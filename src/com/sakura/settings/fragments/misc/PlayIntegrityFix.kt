...
class PlayIntegrityFix : SettingsPreferenceFragment() {
    ...
    private fun refreshStatus() {
        val content = Settings.System.getString(requireContext().contentResolver, PIF_CONFIG_KEY)
    ...
    /**
     * Updates a key-value pair in the active config stored in Settings.System.
    ...
    private fun updateConfigValue(key: String, value: String) {
        try {
            val existing = Settings.System.getString(requireContext().contentResolver, PIF_CONFIG_KEY)
    ...
    companion object {
        ...
        /**
         * Reads the config from a JSON string (stored in Settings.System).
         ...
         * suitable for storage in Settings.System.
         */
